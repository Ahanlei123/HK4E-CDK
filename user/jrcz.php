...
$sql = "SELECT * FROM cz_ddsj WHERE STR_TO_DATE(ddsj, '%Y-%m-%d') = CURDATE()";
//建立查找所有用户信息
$result = mysqli_query($root,$sql);
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        if($Am['zt'] == "1"){
                                            ...
                                            echo "<span style='color:green;'>管理员赠送</span>";
                                        }else{
                                            echo "<span style='color:red;'>未支付</span>";
                                        }
                                        ?></td>
                                        <td>
                                            <a id="btn-"><button type="button" class="btn btn-primary btn-xs">补单</button></a>
                                        </td>
                                        <?php $i++;?>
                                    </tr>
                                    <?php }?>
