            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>苹果安装CDK生成 <small>苹果安装CDK生成</small></h5>
                    ...
                    <div class="ibox-content">
                        <form action="" method="post" class="form-horizontal">
                            ...
                            <div hidden class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="giveid" name="giveid" value="IOS" class="form-control">
                                </div>
                            </div>
                            <div hidden class="form-group">
                                <label class="col-sm-2 control-label">物品数量</label>
                                <div class="col-sm-10">
                                    <input type="text" id="number" name="number" value="IOS" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
