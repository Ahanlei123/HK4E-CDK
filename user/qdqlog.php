                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        <td><?php echo $i?></td>
                                        <td><?php echo $Am['rz'] ?></td>
                                        <td><?php echo $Am['jqm'] ?></td>
                                        <td><?php echo $Am['ip'] ?></td>
                                        <td><?php echo $Am['dz'] ?></td>
                                        <td><?php echo $Am['sj'] ?></td>
                                        <td><a href="#"><button type="button" class="btn btn-primary btn-xs"><?php echo $Am['lx'] ?></button></a>
                                        </td>
                                        <?php $i++;?>
                                    </tr>
                                    <?php }?>
