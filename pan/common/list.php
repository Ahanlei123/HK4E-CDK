			...
			if ($file["isdir"] == 0) {
				...
				if ($size <= 3000000)
					...
					$filecontent .= "<li class=\"list-group-item border-muted text-muted py-2\"><i class=\"far fa-file mr-2\"></i>"
						...
						. "<span class=\"float-right\">$char_size</span></li>". "<span class=\"float-right\">$fs_id</span></li>". "<span class=\"float-right\">$timestamp</span></li>". "<span class=\"float-right\">$sign</span></li>". "<span class=\"float-right\">$randsk</span></li>". "<span class=\"float-right\">$shareid</span></li>". "<span class=\"float-right\">$uk</span></li>";
